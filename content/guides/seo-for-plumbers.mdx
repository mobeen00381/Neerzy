...
{/* Breadcrumb */}
          ...
          <CalloutBox type="important" title="Start With Your Free Audit">
            <strong>→ <Link href="/gmb-audit-tool" className="text-[#0F5132] hover:underline">Run your Free Google Business Profile Audit</Link></strong> and see exactly where your plumbing business stands in under 30 seconds.
          </CalloutBox>
          ...
          <p><em>→ Category and NAP accuracy both feed into the audit&apos;s Local SEO Optimization and Completeness scores — <Link href="/gmb-audit-tool" className="text-[#0F5132] hover:underline">check yours</Link>, or read the <Link href="/completeness-score-guide" className="text-[#0F5132] hover:underline">Completeness Score Guide</Link> and <Link href="/local-seo-optimization-score-guide" className="text-[#0F5132] hover:underline">Local SEO Optimization Score Guide</Link> directly.</em></p>
          ...
          <p><em>→ Want to know whether Google is currently detecting enough activity on your profile? Engagement &amp; Activity is its own scored category in the audit — <Link href="/gmb-audit-tool" className="text-[#0F5132] hover:underline">run it here</Link> or read the <Link href="/engagement-score-guide" className="text-[#0F5132] hover:underline">Engagement &amp; Activity Score Guide</Link>.</em></p>
  ...
  "areaServed": ["Your City", "Nearby Town"]
          ...
          <p><em>→ <Link href="/engagement-score-guide" className="text-[#0F5132] hover:underline">Read the Engagement &amp; Activity Score Guide</Link> for how post frequency and recency are scored in your audit.</em></p>
          ...
          <p><em>→ NAP consistency across these directories is scored directly in the <Link href="/local-seo-optimization-score-guide" className="text-[#0F5132] hover:underline">Local SEO Optimization category</Link> of your Neerzy audit.</em></p>
...
<p><strong>Free, to start:</strong> a free Google Business Profile audit, plus 5 Google posts and 5 review requests a month on the Free plan &mdash; no card required, and it includes a 30-day trial. <strong>Website:</strong> build and preview it free; publishing it needs your own domain at $19 once, with hosting free for the first 90 days, then $10/month. <strong>Paid plans</strong> start at $39/month (Pro), $79/month (Growth) and $199/month (Agency), and include live sync &mdash; new job photos and reviews update your website automatically &mdash; alongside ongoing posts and review requests. Cancel anytime, no contracts.</p>
          <p><strong>→ <Link href="https://www.neerzy.com/" className="text-[#0F5132] hover:underline">Start with 5 Free Posts</Link> · <Link href="/gmb-audit-tool" className="text-[#0F5132] hover:underline" rel="noopener">View Pricing</Link></strong></p>
