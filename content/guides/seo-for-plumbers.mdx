...
{/* Breadcrumb */}
          ...
          <CalloutBox type="important" title="Start With Your Free Audit">
            <strong>→ <Link href="/gmb-audit-tool" className="text-blue-600 hover:underline">Run your Free Google Business Profile Audit</Link></strong> and see exactly where your plumbing business stands in under 30 seconds.
          </CalloutBox>
          ...
          <p><em>→ Category and NAP accuracy both feed into the audit&apos;s Local SEO Optimization and Completeness scores — <Link href="/gmb-audit-tool" className="text-blue-600 hover:underline">check yours</Link>, or read the <Link href="/completeness-score-guide" className="text-blue-600 hover:underline">Completeness Score Guide</Link> and <Link href="/local-seo-optimization-score-guide" className="text-blue-600 hover:underline">Local SEO Optimization Score Guide</Link> directly.</em></p>
          ...
          <p><em>→ Service area setup is checked as part of the audit&apos;s Local SEO Optimization score — <Link href="/gmb-audit-tool" className="text-blue-600 hover:underline">run your audit</Link> or read the <Link href="/local-seo-optimization-score-guide" className="text-blue-600 hover:underline">Local SEO Optimization Score Guide</Link> to see if it&apos;s limiting your visibility.</em></p>
          <h3>Products</h3>
          ...
          <p><em>→ Want to know whether Google is currently detecting enough activity on your profile? Engagement &amp; Activity is its own scored category in the audit — <Link href="/gmb-audit-tool" className="text-blue-600 hover:underline">run it here</Link> or read the <Link href="/engagement-score-guide" className="text-blue-600 hover:underline">Engagement &amp; Activity Score Guide</Link>.</em></p>
          ...
          <p><em>→ NAP consistency across the web is part of the audit&apos;s Local SEO Optimization score — <Link href="/gmb-audit-tool" className="text-blue-600 hover:underline">check yours</Link> or read the <Link href="/local-seo-optimization-score-guide" className="text-blue-600 hover:underline">Local SEO Optimization Score Guide</Link> to catch mismatches before they cost you rankings.</em></p>
          <h3>Geo Signals</h3>
  ...
  "areaServed": ["Your City", "Nearby Town"]
          ...
          <p><em>→ <Link href="/engagement-score-guide" className="text-blue-600 hover:underline">Read the Engagement &amp; Activity Score Guide</Link> for how post frequency and recency are scored in your audit.</em></p>
          ...
          <p><em>→ NAP consistency across these directories is scored directly in the <Link href="/local-seo-optimization-score-guide" className="text-blue-600 hover:underline">Local SEO Optimization category</Link> of your Neerzy audit.</em></p>
          ...
          <p>The tool returns a single score out of 100, along with a plain-language summary and a category-by-category breakdown showing exactly which of the five areas are dragging the score down. Read <Link href="/understanding-your-gbp-audit-score" className="text-blue-600 hover:underline">Understanding Your Audit Score</Link> for the full breakdown, or go straight to <Link href="/improve-your-audit-score" className="text-blue-600 hover:underline">How to Improve Your Overall Audit Score</Link> for the action-first version.</p>
          ...
          <p><strong>→ <Link href="https://www.neerzy.com/" className="text-blue-600 hover:underline">Start with 5 Free Posts</Link> · <Link href="/gmb-audit-tool" className="text-blue-600 hover:underline" rel="noopener">View Pricing</Link></strong></p>
