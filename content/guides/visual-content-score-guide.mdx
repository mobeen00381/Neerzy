...
<p>Visual Content is weighted at 20% in <Link href="/gmb-audit-tool" className="text-[#0F5132] hover:underline">Neerzy&apos;s free GBP audit</Link> — the third-highest category after Completeness and Reviews &amp; Reputation. It&apos;s also one of the fastest to move, since it depends entirely on you uploading photos, not on customer behavior.</p>
        ...
        <ul>
          ...
          <li><Link href="/seo-for-plumbers#section-5" className="text-[#0F5132] hover:underline">Section 5 of the full plumbing SEO guide</Link> — Photos and Videos subsections</li>
        </ul>
        ...
        <CalloutBox type="tip" title="Run or Re-Run Your Free Audit">
          <Link href="/gmb-audit-tool" className="text-[#0F5132] hover:underline font-semibold">→ Run or re-run your free audit</Link> after your next upload batch.
        </CalloutBox>