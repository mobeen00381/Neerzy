        ...
        <div className="container mx-auto px-4 max-w-6xl py-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            ...
            <span className="bg-purple-100 text-purple-700 px-3 py-1 rounded-full text-sm font-medium border border-purple-200">
              Early Access — {selectedPlan === "pro" ? "Pro" : "Free"} Plan
            </span>
          </div>
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div className="text-2xl font-extrabold my-2 text-blue-900">$39<span className="text-sm text-blue-500 font-normal">/mo</span></div>
                  <p className="text-sm text-blue-700">25 AI updates per month for maximum local SEO.</p>
                </div>
              </div>
            </div>
          )}
