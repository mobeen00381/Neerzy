...
export default function AuditToolClient() {
  ...
  // NOTE: the JSON-LD schemas for this route (SoftwareApplication, FAQPage,
  // BreadcrumbList and — once enough reviews are published — the reviews
  // AggregateRating) are built in the server component instead, so they render
  // server-side from the same data the page displays:
  //   src/app/gmb-audit-tool/page.tsx

  // FAQ copy lives in src/lib/gmb-audit-faqs.ts so the accordion below and the
  // FAQPage JSON-LD emitted by page.tsx can never drift apart.
