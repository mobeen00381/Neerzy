...
import { Users, TrendingUp, Activity, Globe, Download, ChevronRight, CheckCircle2, Link2, Copy, Check, Plus, Clock, Trash2, MessageSquare } from "lucide-react";
...
export default function AdminDashboard() {
  const users = [
    { id: 1, name: "Acme Plumbing", email: "john@acmeplumbing.com", plan: "Pro", status: "Active", domain: "acmeplumbing.com", posts: 12 },
    { id: 2, name: "Texas Electric", email: "sarah@texaselectric.com", plan: "Growth", status: "Active", domain: "texaselectric.com", posts: 45 },
    { id: 3, name: "Sparkle Cleaning", email: "mike@sparklecleaning.com", plan: "Free", status: "Active", domain: "sparklecleaning.com", posts: 3 },
    { id: 4, name: "Frostbite Cooling", email: "david@frostbite.com", plan: "Pro", status: "Active", domain: "frostbitecooling.com", posts: 22 },
    { id: 5, name: "Demo User", email: "—", plan: "Free", status: "Demo", domain: "demo-preview.seojunction.com", posts: 1 },
  ];
                      ...
                      <td className="px-6 py-4">
                         <div className="flex items-center gap-2">
                           <div className="w-16 bg-slate-100 rounded-full h-2">
                              <div className="bg-blue-500 h-2 rounded-full" style={{ width: `${(user.posts / (user.plan === 'Growth' ? 60 : user.plan === 'Pro' ? 25 : 5)) * 100}%` }} />
                           </div>
                           <span className="text-xs font-bold">{user.posts}/{user.plan === 'Growth' ? '60' : user.plan === 'Pro' ? '25' : '5'}</span>
                         </div>
                      </td>
                      <td className="px-6 py-4">
