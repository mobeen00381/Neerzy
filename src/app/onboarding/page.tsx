...
function OnboardingContent() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center p-8 text-center overflow-hidden relative">
      {/* Background Decor */}
      ...
      <div className="relative z-10 max-w-md w-full animate-in fade-in zoom-in-95 duration-1000">
        <div className="w-24 h-24 bg-blue-600 rounded-[2.5rem] flex items-center justify-center mx-auto mb-10 shadow-2xl shadow-blue-500/20 animate-bounce">
        ...
        <p className="text-slate-400 text-lg font-medium mb-12 leading-relaxed">
          Setting up your <span className="text-blue-400 font-black capitalize">{plan}</span> infrastructure. Almost ready for your first post!
        </p>
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2rem] p-8 mb-12">
           <div className="flex items-center gap-4 text-left mb-6">
              ...
              <div>
                 <p className="text-[10px] text-slate-500 font-black uppercase tracking-widest">Current Task</p>
                 <p className="text-white font-bold">{status}</p>
              </div>
           </div>
           <div className="w-full bg-white/10 rounded-full h-2 overflow-hidden">
              <div className="bg-blue-500 h-full animate-progress" style={{ width: '100%' }} />
           </div>
        </div>

        <div className="flex items-center justify-center gap-2 text-slate-500 font-bold text-sm uppercase tracking-tighter">
